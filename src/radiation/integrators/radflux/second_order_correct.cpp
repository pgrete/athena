...
void RadIntegrator::SecondOrderCorrectFluxX1(Coordinates *pco, const int k, const int j,
...
void RadIntegrator::SecondOrderCorrectFluxX2(Coordinates *pco, const int k, const int j,
  const int i, const AthenaArray<Real> &q, const AthenaArray<Real> &vel,
  AthenaArray<Real> &flx)
{
...
void RadIntegrator::SecondOrderCorrectFluxX3(Coordinates *pco, const int k, const int j,
  const int i, const AthenaArray<Real> &q, const AthenaArray<Real> &vel,
  AthenaArray<Real> &flx)
{
