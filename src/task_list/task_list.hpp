...
const std::uint64_t INT_PAR  = 1LL<<57;
const std::uint64_t SEND_PAR = 1LL<<58;
const std::uint64_t RECV_PAR = 1LL<<59;
const std::uint64_t SEND_PM  = 1LL<<60;
const std::uint64_t RECV_PM  = 1LL<<61;
}  // namespace HydroIntegratorTaskNames
