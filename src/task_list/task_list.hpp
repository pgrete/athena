...
const std::uint64_t INT_PAR  = 1LL<<50;
const std::uint64_t SEND_PAR = 1LL<<51;
const std::uint64_t RECV_PAR = 1LL<<52;
const std::uint64_t SEND_PM  = 1LL<<53;
const std::uint64_t RECV_PM  = 1LL<<54;
} // namespace HydroIntegratorTaskNames
