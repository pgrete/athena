...
static Real zdg_, xHe_, cr_rate_, bCO_;
//index of species
...
static int igSi_ = FindStrIndex(ChemNetwork::species_names, NSPECIES, "*Si");
static int igS_ = FindStrIndex(ChemNetwork::species_names, NSPECIES, "*S");
static int igC_ = FindStrIndex(ChemNetwork::species_names, NSPECIES, "*C");
static int igO_ = FindStrIndex(ChemNetwork::species_names, NSPECIES, "*O");
static int igHe_ = FindStrIndex(ChemNetwork::species_names, NSPECIES, "*He");
static int igH_ = FindStrIndex(ChemNetwork::species_names, NSPECIES, "*H");
...
static const int out2body3_[n_2body_] = 
...
static const int outph1_[n_ph_] = {
              iCplus_, igC_, igC_, igO_, igH_,
							iSplus_, iSiplus_};
static const int outph2_[n_ph_] = {
