...
ST_rho_r1=np.zeros((ny,num_file))
ST_rho_r2=np.zeros((ny,num_file))
ST_rho_r3=np.zeros((ny,num_file))
ST_rho_r4=np.zeros((ny,num_file))

ST_B3_r1=np.zeros((ny,num_file))
ST_B3_r2=np.zeros((ny,num_file))
ST_B3_r3=np.zeros((ny,num_file))
ST_B3_r4=np.zeros((ny,num_file))

ST_Er_r1=np.zeros((ny,num_file))
ST_Er_r2=np.zeros((ny,num_file))
ST_Er_r3=np.zeros((ny,num_file))
ST_Er_r4=np.zeros((ny,num_file))

ST_T_r1=np.zeros((ny,num_file))
ST_T_r2=np.zeros((ny,num_file))
ST_T_r3=np.zeros((ny,num_file))
ST_T_r4=np.zeros((ny,num_file))
...
#      gasT_1d[j*nr+i]=gasT[j,i]
  ...
  ST_rho_r1[:,count]=rho_cart[:,rloc_cart[0,1]]
  ST_rho_r2[:,count]=rho_cart[:,rloc_cart[1,1]]
  ST_rho_r3[:,count]=rho_cart[:,rloc_cart[2,1]]
  ST_rho_r4[:,count]=rho_cart[:,rloc_cart[3,1]]

  ST_B3_r1[:,count]=B3_cart[:,rloc_cart[0,1]]
  ST_B3_r2[:,count]=B3_cart[:,rloc_cart[1,1]]
  ST_B3_r3[:,count]=B3_cart[:,rloc_cart[2,1]]
  ST_B3_r4[:,count]=B3_cart[:,rloc_cart[3,1]]


  ST_Er_r1[:,count]=Er_cart[:,rloc_cart[0,1]]
  ST_Er_r2[:,count]=Er_cart[:,rloc_cart[1,1]]
  ST_Er_r3[:,count]=Er_cart[:,rloc_cart[2,1]]
  ST_Er_r4[:,count]=Er_cart[:,rloc_cart[3,1]]

  ST_T_r1[:,count]=gasT_cart[:,rloc_cart[0,1]]
  ST_T_r2[:,count]=gasT_cart[:,rloc_cart[1,1]]
  ST_T_r3[:,count]=gasT_cart[:,rloc_cart[2,1]]
  ST_T_r4[:,count]=gasT_cart[:,rloc_cart[3,1]]
...
np.savetxt('ST_rho_'+'{:.0f}'.format(rloc_cart[0,0])+'.txt',ST_rho_r1,fmt='%4.5e')
np.savetxt('ST_rho_'+'{:.0f}'.format(rloc_cart[1,0])+'.txt',ST_rho_r2,fmt='%4.5e')
np.savetxt('ST_rho_'+'{:.0f}'.format(rloc_cart[2,0])+'.txt',ST_rho_r3,fmt='%4.5e')
np.savetxt('ST_rho_'+'{:.0f}'.format(rloc_cart[3,0])+'.txt',ST_rho_r4,fmt='%4.5e')

np.savetxt('ST_B3_'+'{:.0f}'.format(rloc_cart[0,0])+'.txt',ST_B3_r1,fmt='%4.5e')
np.savetxt('ST_B3_'+'{:.0f}'.format(rloc_cart[1,0])+'.txt',ST_B3_r2,fmt='%4.5e')
np.savetxt('ST_B3_'+'{:.0f}'.format(rloc_cart[2,0])+'.txt',ST_B3_r3,fmt='%4.5e')
np.savetxt('ST_B3_'+'{:.0f}'.format(rloc_cart[3,0])+'.txt',ST_B3_r4,fmt='%4.5e')

np.savetxt('ST_Er_'+'{:.0f}'.format(rloc_cart[0,0])+'.txt',ST_Er_r1,fmt='%4.5e')
np.savetxt('ST_Er_'+'{:.0f}'.format(rloc_cart[1,0])+'.txt',ST_Er_r2,fmt='%4.5e')
np.savetxt('ST_Er_'+'{:.0f}'.format(rloc_cart[2,0])+'.txt',ST_Er_r3,fmt='%4.5e')
np.savetxt('ST_Er_'+'{:.0f}'.format(rloc_cart[3,0])+'.txt',ST_Er_r4,fmt='%4.5e')

np.savetxt('ST_T_'+'{:.0f}'.format(rloc_cart[0,0])+'.txt',ST_T_r1,fmt='%4.5e')
np.savetxt('ST_T_'+'{:.0f}'.format(rloc_cart[1,0])+'.txt',ST_T_r2,fmt='%4.5e')
np.savetxt('ST_T_'+'{:.0f}'.format(rloc_cart[2,0])+'.txt',ST_T_r3,fmt='%4.5e')
np.savetxt('ST_T_'+'{:.0f}'.format(rloc_cart[3,0])+'.txt',ST_T_r4,fmt='%4.5e')

np.savetxt('height.txt',ygrid,fmt='%4.3e')
